...
#
# 1. The git repository containing the Dockerfile and assets, e.g. https://github.com/SUSE/fissile-stemcell-SLES
#
...
cp -r src/. versioned-fissile-stemcell-sles
cd versioned-fissile-stemcell-sles
git fetch --tags
