...
export BOSH_GW_HOST="$( state_path /instance_groups/name=bosh/networks/name=${env}/static_ips/0 2>/dev/null )"
export BOSH_GW_USER="jumpbox"
export BAT_PRIVATE_KEY="$( creds_path /jumpbox_ssh/private_key )"

export BAT_DNS_HOST="$( state_path /instance_groups/name=bosh/networks/name=${env}/static_ips/0 2>/dev/null )"
